...
export const technologyYouDontNeedPost: Article = {
  ...
  art: { label: "Perspectives", cells: ["When the best move is no move"], tone: "slate" },
  body: [
    p(
    ...
    {
      t: "table",
      caption: "Signals that 'no change' may be correct",
      head: ["Signal","What it usually means"],
      rows: [
              [
                      "Operations meets targets with current tools",
                      "The bottleneck is elsewhere"
              ],
              [
                      "The proposed change requires every team to move at once",
                      "Absorption cost exceeds benefit"
              ],
              [
                      "Nobody can name who owns exceptions after go-live",
                      "You are not ready to change"
              ],
              [
                      "The business case depends on headcount reduction",
                      "The real problem is workload design"
              ],
              [
                      "The demo works but the join does not",
                      "Wait for a smaller slice, not a bigger programme"
              ]
      ],
    },
    note("A good 'no change' decision is written down. It includes what would make you reconsider. Undocumented inertia is not the same thing."),
    ...
    {
      t: "table",
      caption: "Visible vs hidden costs of change",
      head: ["Cost type","Usually in the business case?","Typical owner"],
      rows: [
              [
                      "Licence or build fees",
                      "Yes",
                      "Procurement / IT"
              ],
              [
              ...
              [
                      "Attention diverted from other fixes",
                      "No",
                      "Leadership"
              ],
              [
                      "Unwind if the change stalls",
                      "No",
                      "Everyone, eventually"
              ]
      ],
    ...
    quote("The mature organisation is not the one that changes fastest. It is the one that can explain why it did not change, and what it did instead."),
    ...
    h2("How this shows up in steering forums"),
    p(
      "A programme is proposed because a peer published a case study. The business case assumes adoption without naming what stops. Operations is consulted after shortlisting. The comparison treats inertia as zero cost. The decision becomes whether to buy A or B, not whether to move at all.",
    ),
    p(
      "Reframe the forum: ask what happens if the organisation changes nothing for twelve months under current constraints. Ask what must be true for a purchase to beat that path. Ask who signs the stop list. Those questions restore the fourth option — deliberate hold — to legitimate debate.",
    ),
    h2("A written 'hold' decision template"),
    ul([
      "Problem as named today, without product language.",
      "Constraint that binds this year (capacity, budget, risk appetite).",
      "What was considered and deferred.",
      "What will be done instead (process, ownership, join).",
      "Signal that reopens the decision (metric, date, event).",
      "Owner who watches the signal.",
    ]),
    p(
      "A hold with that structure is not delay. It is governance that prevents reflex purchase when the real bottleneck is elsewhere.",
    ),
    cta(
