...
import {
  switchingFrictionMattersMoreThanBrandLoyaltyPost,
  theOperatingModelProblemWhenACompanyOutgrowsItsOrganizationPost,
  marketEntryWithoutGuessworkFrameworkForChoosingTheNextMarketPost,
  theMoatTestWhichCompetitiveAdvantagesSurviveTenYearsPost,
  theDecisionLatencyProblemHowMuchDoesASlowCompanyLosePost,
  businessResilienceAsCompetitiveAdvantageNotInsurancePost,
  theCustomerConcentrationTrapHowMuchRevenueIsTooMuchPost,
  strategicFocusHasAnEconomicValuePost,
  theThreeSpeedCompanyWhyEveryBusinessShouldNotMoveAtTheSameSpeedPost,
  theGrowthTrapWhenRevenueGrowthMakesACompanyWeakerPost,
  theOneDollarAllocationProblemWhereShouldACompanyInvestNextPost,
  pricingPowerHowDoYouKnowWhenCustomersWillPayMorePost,
  revenueLeakageWhereCompaniesLoseMoneyAfterTheSalePost,
  theComplexityTaxHowSuccessfulCompaniesBecomeLessProfitableAsTheyGrowPost,
  strategyExecutionGapWhyGoodStrategiesFailAfterTheBoardroomPost,
